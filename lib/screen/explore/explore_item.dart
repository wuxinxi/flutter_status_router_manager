...
class ExploreItem extends StatefulWidget {
  ...
  const ExploreItem({Key? key, required this.index, required this.recipeModel})
      : super(key: key);
...
class _RecipeItemState extends State<ExploreItem> {
  @override
  void initState() {
    super.initState();
  }
            ...
            Positioned(
                child: Selector(
                  ...
                  selector: (context, AppRecipeModel appRecipeModel) =>
                      appRecipeModel.exploreRecipeModelList[index].favourite,
                ),
                right: 10.0,
                top: 10.0)
          ]),
